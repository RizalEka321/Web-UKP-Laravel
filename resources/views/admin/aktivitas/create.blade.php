...
<body>
    <div class="container p-4">
        <a class="btn btn-lg btn-danger" type="button" href="{{ url('/aktivitas') }}">Kembali</a>
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                ...
                @endif
                <form action="{{ url('/aktivitas/store') }}" method="post" enctype="multipart/form-data">
                    @method('post')
                    @csrf
                    <div class="mb-3">
                        <label for="tanggal">Nomor MOU:</label>
                        <input type="text" class="form-control" name="nomor_mou" placeholder="Nomor MOU">
                    </div>
                    <div class="mb-3">
